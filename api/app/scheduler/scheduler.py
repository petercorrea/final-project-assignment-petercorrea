...
class LightScheduler(Scheduler):
    ...
    def construct_command(self, **kwargs):
        logging.info(kwargs)
        return f'python ~/autogarden/api/app/sensors/light/light.py --{kwargs["state"]} --brightness {kwargs["brightness"]}'
...
class PumpScheduler(Scheduler):
    ...
    def construct_command(self,**kwargs):
        return f'python ~/autogarden/api/app/sensors/pump/pump.py --{kwargs["state"]} --speed {kwargs["speed"]}'
...
class LogScheduler(Scheduler):
    ...
    def construct_command(self,**kwargs):
        return f'~/autogarden/bin/api/app/log-sensor-data.sh'
